...
class SlideHomePage extends StatefulWidget {
  const SlideHomePage({Key? key}) : super(key: key);
      ...
      child: Column(
        children: [
          CarouselSlider(
            ...
            items: ConvertWidget.ImagesToWidget(imgList),
          ),
          Row(
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: _current == entry.key ? AppColors.activeColor:AppColors.noneActiveColor
                  ),
                ),
              );
            }).toList(),
